	      ...
	      <form method="post">
	           ...
	           <div class="re_edit_txt" id="re_edit_txt${list.help_reply_id}" style="display:none">
		           <textarea class="edit-input" id="edit-input${list.help_reply_id}" name="re_comment_edit" placeholder="댓글을 입력해 주세요." style="resize:none">${list.re_comment}</textarea>
	           	   <input type=submit class="edit-go" id="edit_go${list.help_reply_id}" value="수정" onclick="javascript: form.action='helpyou_reply_edit';"/>
	...
	var login_user_id=$('#login_user_id').val();
	   if(login_user_id==null || login_user_id==""){
		   ...
		   window.open("request_popup?nick="+$('#nick').val()+
			   ...
			   "requestPop",'width=470, height=580, left=400, top=200, resizable=no');
	   }
})
			...
			function(data){
				...
				$.each(data,function(ndx,value){
					...
					if("${login.user_id}"==value['user_user_id']||"${login.user_id}"=="admin"){
		            	 ifbtn='<input type=submit class=re_remove value=삭제 onclick="javascript: form.action=\'helpyou_reply_delete\';"/>'
						...
						+'<form mehtod="post">'
				            ...
				            +'<form method="post">'
				                ...
				                +'<div class="re_edit_txt" id=re_edit_txt'+value['help_reply_id']+' style=display:none>'
					                ...
					                +'<input type=submit class=edit-go id=edit_go'+value['help_reply_id']+' value="수정" onclick="javascript: form.action=\'helpyou_reply_edit\'";/>'
				                ...
				                +'<div class=reply_again_txt id=reply_again_textarea'+value['help_reply_id']+' style=display:none>'
						            ...
						            +'<input type=submit class=re_re_submit id="re_re_submit'+value['help_reply_id']+'" value="등록" onclick="javascript: form.action=\'helpyou_re_recomment_submit\'";/>'
				                +'</div>'
				                +'<div id="clr"></div>'
