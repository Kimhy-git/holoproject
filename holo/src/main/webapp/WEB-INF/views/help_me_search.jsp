                ...
                <div id="content">
                    ...
                    <c:forEach var="list" items="${list}">
                        <li>
                        	...
                        	<div id="box" onclick="location.href='/holo/helpme_write_view?help_post_id=${list.help_post_id}'">
...
function fn_prev(page, range, rangeSize) {
		...
		var range = range - 1;
		var url = "${pageContext.request.contextPath}/help_me_search";

		url = url + "?page=" + page;
		url = url + "&range=" + range;
		url = url + "&area=" + '${map.area}';
		url = url + "&search_option=" + '${map.search_option}';
		url = url + "&keyword=" + '${map.keyword}';
		url = url + "&tagJob=" + '${map.tagJob}';
